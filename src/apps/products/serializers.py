...
class OrderSerializer(serializers.ModelSerializer):
    ...
    def get_product_id(self, obj):
        try:
            product = ProductItem.objects.get(name=obj.product_name)
    ...
    def _get_price_for_product(self, product_name):
        try:
            product = ProductItem.objects.get(name=product_name, is_active=True)
        except ProductItem.DoesNotExist:
            raise serializers.ValidationError(f"Товар '{product_name}' не найден.")
